...
public class Keybinds {
    ...
    public static KeyBinding enableAutoSwap;
    ...
    public static void register() {
        ...
        enableAutoSwap = KeyBindingHelper.registerKeyBinding(new KeyBinding(
                "enable auto swap", // The translation key of the keybinding's name
                InputUtil.Type.KEYSYM, // The type of the keybinding, KEYSYM for keyboard, MOUSE for mouse.
                GLFW.GLFW_KEY_UNKNOWN, // The keycode of the key
                "MQOL" // The translation key of the keybinding's category.
        ));
